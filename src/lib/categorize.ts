...
const RULES: Array<[RegExp, Category]> = [
  ...
  [/\b(earthquake|deaths|dead|disaster|emergency|rescue|evacuate|collapse|accident|crash|explosion|bomb|blast|fire|flood|landslide|outbreak|epidemic|pandemic|famine|humanitarian crisis)\b/i, 'disaster'],
  [/\b(war|warfare|killed|kills|airstrike|bombing|troops|military|missile|attack|combat|fighting|gunfire|shelling|ceasefire|insurgent|rebel|terrorist|hostage|weapon|armed|soldier|battalion|siege|offensive|frontline|sniper|drone strike|car bomb|suicide bomb|artillery|navy|air force|fleet)\b/i, 'conflict'],
